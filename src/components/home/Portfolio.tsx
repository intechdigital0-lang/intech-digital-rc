...
const Portfolio = () => {
  ...
  return (
    <section id="portfolio" className="py-10 md:py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-center text-center mb-8 md:mb-16 gap-4 md:gap-6">
